...
int main(void){
    ...
    printf("Menu:\n");
    printf("1 - Calculadora V1\n");
    printf("2 - Calculadora V2\n");
    printf("3 - Calculadora V3\n");
    printf("\n");
    ...
    switch(menu){
        ...
        case 2:
            ...
            printf("Calculadora Versão 2\n");
            printf("Esse programa tem como objetivo realizar calcullos basicos\n");
            printf("Feito por: Yuri1502, Matricula: 123456789\n");
